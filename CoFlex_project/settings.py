...
SAND_FIRST_FERNET_KEY = config('SAND_FIRST_FERNET_KEY').encode()
SAND_SECOND_FERNET_KEY = config('SAND_SECOND_FERNET_KEY').encode()
...
SAND_FERNET_KEY_LAST_FOUR_DIGITS = config('SAND_FERNET_KEY_LAST_FOUR_DIGITS').encode()

FERNET_KEY_LAST_FOUR_DIGITS = config('FERNET_KEY_LAST_FOUR_DIGITS').encode()
